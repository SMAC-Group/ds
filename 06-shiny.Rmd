...
Let us start witht he function `cast_needle()`. This function has a single input, i.e. the width of the (square) plane on which the needle is casted and returns a list containing:
