...
- **Type**, which corresponds the "kind" of objects in contains.
- **Length**, i.e. the number of elements in a vector. 
- **Attributes**, some additional metadata attached to a vector.

I think we should make up a story: "we are interested in studying something, you get data". Let's store them in R.
