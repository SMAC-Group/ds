...
**Justin: Maybe something on hyperlinks**
...
Within the text section, you can also include LaTeX format to output equation format. Inline mathematical expressions can be added using the syntax: `$math expression$`. For example, if we want to write: "where $\alpha$ is in degrees" we would write:
