...
## Initialize and create an R Markdown file in RStudio

Within RStudio, click `File` → `New File` → `R Markdown`. Give the file[^1] a title and the author 
...
[^1]: http://kbroman.org/datacarpentry_R_2017-01-10/img/New_R_Markdown.png
