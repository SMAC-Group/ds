...
This may look like a complicated 
The easiest way ...
...
Click on BibTex and this will appear. You can simply cut in paste in bib file.
...
To inlcude refs (if you already have a bib file skip)

1. Create empty text file and change its extension to bib (e.g. bibli.bib)
2. Add references to your bib file (see e.g. importation from google scholar)
3. Change YAML
