...
JUSTIN: Provide more details on these options, maybe discussing a couple of them and modifying the tutorial example code to show how the interface changes.
...
JUSTIN: Provide more details of the possible outputs that can be assigned to the output object aside from renderPlot().
...
JUSTIN: maybe discuss more in detail which aspects of the app can be customized and provide some R code examples using the faithful data (as done above).
