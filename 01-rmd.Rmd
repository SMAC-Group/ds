...
ui <- miniPage(
  ...
  miniTabstripPanel(
    ...
    miniTabPanel("R Markdown", icon = icon("terminal"),
      miniContentPanel(
        verbatimTextOutput(outputId = "raw")
      )
    ),

    miniTabPanel("Compiled HTML", icon = icon("code"),
      miniContentPanel(
        uiOutput('html')
      )
    ),

    miniTabPanel("BibTeX File", icon = icon("book"),
      miniContentPanel(
        verbatimTextOutput(outputId = "bib")
      )
    )
  )
),
