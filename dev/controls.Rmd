...
Often when we are coding, we need to control the flow of our actions. Just like in daily day to day life, we need to place conditions in which we manipulate our behavior. For example, 
...
Control structures allow us to control the flow of code execution. For example, 
