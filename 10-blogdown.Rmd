...
The easiest way to create a document in to click on `Addins > Blogdown > New post` which generates a windows through a shiny app. Here is an example:
