...
fit_lm = lm(hubble$y~hubble$x)
summary(fit_lm)

# Compare outputs
manual_results = c(beta.hat, sigma.hat)
function_results = c(fit_lm$coefficients[2], var(fit_lm$residuals))
cbind(manual_results, function_results)
```
