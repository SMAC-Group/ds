...
A basic introduction to LaTeX format can be found [here](http://www.math.harvard.edu/texman/), but an alternative can be to insert custom LaTeX formulas using a graphical interface such as [codecogs](https://www.codecogs.com/latex/eqneditor.php). 
