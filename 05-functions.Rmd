...
If you are interested in understanding how Eq. \@ref(eq:lsformula) is derived, click on the buttom. If you're not familiar with such calculations we suggest you read some introduction to linear regression [see for example @seber2012linear].
...
and if you are interested, you can click on the buttom below to see how this formula was derived.
